    ...
    public class InventoryMenu : Popup
    {
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
           ...
           foreach (var pair in _headings)
            ...
            spriteBatch.Draw(_game.Textures.Sprites["Player"].Statics["Idle"], _playerPosition, null, Color.White, 0f, Vector2.Zero, 1.5f * Game1.ResScale, SpriteEffects.None, Layer + 0.001f);
        }
